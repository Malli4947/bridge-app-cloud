...
function TimelineItem({ exp, delay }: { exp: ExpType; delay: number }) {
  return (
    ...
    >
      ...
      <div className="p-8 bg-bg-card border border-white/10 rounded-2xl transition-all duration-400 hover:border-accent-cyan hover:translate-x-2 hover:shadow-[-8px_8px_30px_rgba(6,212,212,0.1)]">
        <h3 className="font-display text-2xl mb-2 font-semibold">{exp.title}</h3>
